<?php
    ...
    $cateDetails = $productsCate->getTypeDetailsName($type_name);
    $type_id = $cateDetails['type_id'];
    $totalItems =  count($productDetails->getAllProductsTypoList($type_id));
    $itemsPerPage = 20;
    $page = isset($_GET['page']) ? ($_GET['page']) : 1;
    $start = $page > 1 ? ($page * $itemsPerPage) - $itemsPerPage : 0;
    $totalPages = ceil($totalItems / $itemsPerPage);
    $seeProdcut = $productDetails->getAllProductsTypeList($type_id, $start, $itemsPerPage);
?>
                    ...
                    <div class="container">
                        <div class="breadcrumb-inner">
                            <ul class="list-inline list-unstyled">
                                <li><a href="./">Home</a></li>
                                <li><a href="products-types.php?type_name=<?php echo $type_name ?>"> Types</a></li>
                ...
                <div class="sidebar-widget outer-bottom-small wow fadeInUp">
                    ...
                    <div class="sidebar-widget-body outer-top-xs">
                        <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                            ...
                            <div class="item">
                                <div class="products special-product"><?php 
                    ...
                    <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                        <div class="more-info-tab clearfix ">
                            ...
                            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                                ...
                                <li class="active"><a href="products-types.php?type_name=<?php echo $type_name ?> " ><?php echo $type_name ?></a>
                                </li><?php 
                                $cate = $db->prepare("SELECT * FROM product_type WHERE type_name !=:type_name ORDER BY type_id DESC LIMIT 0,5");
