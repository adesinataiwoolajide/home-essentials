      ...
      <div class="logo-slider-inner">
        <div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
          ...
          $brand_name = $see['manufacturer_name']; ?>
            <div class="item"> 
              <a href="#" class="image"> 
                <img data-echo="<?php echo 'manufacturer-logo/'. $see['manufacturer_logo'] ?>" src="assets/images/blank.gif" style="width: 100px ;height: 100px" alt=""> 
              </a> 
              </div><?php 
          } ?>
...
<script type="text/javascript" src="libraries/sweetalert/sweetalert-dev.js"></script>
<script type="text/javascript" src="assets/js/custom.js"></script>
<script type="text/javascript" src="http://arrow.scrolltotop.com/arrow37.js"></script>
<script type="text/javascript" src="libraries/Toast/js/Toast.min.js"></script>
