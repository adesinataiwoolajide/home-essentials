<?php
	...
	try{
		...
		$dir = "../../images/product/large-image/";
		...
		if($file_size > 2097152){
			...
			if(isset($_POST['adding-product'])){
				...
				if(!empty($productDetails->addNewProductDetails($product_name, $product_number, $product_image, $type_id, $manufacturer_id)) AND ($productDetails->insertingTheGenLastNumber($number_type, $year_number, $month, $last_number))){
