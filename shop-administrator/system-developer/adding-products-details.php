        	...
        	<div class="col-md-12">
		        ...
		        <form action="process-adding-product.php" method="post" class="form-horizontal" enctype="multipart/form-data">
	        		<div class="col-md-10">
		                ...
		                <div class="panel-body form-group-separated">    
		                    <div class="form-group col-md-12">
		            		<label class="col-md-2 col-xs-12 control-label">PRODUCT CATEGPRY</label>
		                    <div class="col-md-10 col-xs-12">
		                    	<div class="input-group">
		                            <span class="input-group-addon"><span class="fa fa-sitemap"></span></span>
		                            <input type="text" class="form-control text" name="category_id" placeholder="Enter The Product Size" value="<?php echo $category_name ?>" readonly />
		                        </div>                                            
		                        <span class="help-block" style="color: red;">This is field is Required.</span>
		                    </div>
		                </div>
		                ...
		                <div class="panel-body form-group-separated">    
		                    ...
		                    <div class="col-md-10 col-xs-12">
		                    	<div class="input-group">
		                            <span class="input-group-addon"><span class="fa fa-sitemap"></span></span>
		                            <input type="text" class="form-control text" name="product_size" placeholder="Enter The Product Size" />
		                        </div>                                            
		                        <span class="help-block" style="color: red;">This is field is Required.</span>
		                    </div>
		                </div>
	        		...
	        		<input type="hidden" name="retrnn" value="<?php echo $_SERVER['REQUEST_URI']; ?>">
