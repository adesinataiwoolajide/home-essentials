                                    ...
                                    while($row = $detail->fetch()){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="edit-products-details.php?product_number=<?php echo $product_number ?>" class="btn btn-danger"><i class="fa fa-pencil"></i></a>
                                                <a href="delete-product-details?product_number=<?php echo $product_number ?>" class="btn btn-warning"><i class="fa fa-trash-o"></i></a>
