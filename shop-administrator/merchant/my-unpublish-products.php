<?php
   ...
   // $seeProdcut = $productDetails->getProductsPublishedProducts($merchant_number);
...
<ul class="breadcrumb">
    ...
    <li><a href="my-unpublish-products.php"><i class="fa fa-plus"></i>My Un Publish Product</p></a></li>    
    <li><a href="publish-my-product.php"><i class="fa fa-list"></i> Publish Product</p></a></li>    
    <li><a href="my-unpublished-products.php"><i class="fa fa-ban"></i>Un Publish Product</p></a></li> 
