...
<ul class="breadcrumb">
    ...
    <li><a href="my-published-products.php"><i class="fa fa-cloud"></i>My Published Product</p></a></li>  
    <li><a href="unpublish-my-products.php"><i class="fa fa-ban"></i>Un Publish Product</p></a></li>  
            ...
            <div class="col-md-12"> 
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" ><p style="color: green" align="center">List of All <?php echo $merchant_name ?> Un Published Product</p></h3>
                        <?php include("../table-modal.php"); ?>
                    </div>
                    <div class="panel-body"><?php
                        $detail = $db->prepare("SELECT * FROM products WHERE publish=0 AND merchant_number=:merchant_number ORDER BY product_id DESC");
                        $arr = array(':merchant_number'=>$merchant_number); 
                        $detail->execute($arr); 
                        if($detail->rowCount()==0){ ?>
                            <h3 align="center"><p style="color: red;" align="center">No Un Published Product Was Found For <?php echo $merchant_name ?>. </p></h3><?php
                        }else{ ?>
                            <form action="process-publish-product.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <tbody><?php
                                        ...
                                        while($row = $detail->fetch()){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox" value="1" name="published<?php echo $y; ?>">Publish
                                ...
                                <div class="col-md-12" align="center">
                                    ...
                                    <button class="btn btn-success">Publish The Selected Products</button>
                                </div>
                            </form><?php
