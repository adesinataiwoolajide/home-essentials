<?php
    ...
    $totalItems =  count($productDetails->getProductsPublish($merchant_number));
    $itemsPerPage = 20;
...
<ul class="breadcrumb">
    ...
    <li><a href="my-published-products.php?merchant_number=<?php echo $merchant_number?>"><i class="fa fa-cloud"></i> Published Product</p></a></li>  
     <li><a href="publish-my-product.php"><i class="fa fa-list"></i> Publish My Product</p></a></li>      
    <li><a href="my-unpublish-products.php"><i class="fa fa-ban"></i> Un-Publish Product</p></a></li>     
    ...
    <li class="active"><?php echo $merchant_name ?> Published Product List</li>   
</ul>
<!-- END BREADCRUMB -->                       
<?php
...
<div class="page-content-wrap"><?php 
    if($productDetails->checkMerchantPublishedProductsDet($merchant_number)){ ?>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <p style="color: red" align="center"><?php echo $merchant_name ?> Published Products is Empty</p>                          
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <p style="color: green" align="center"><?php echo $merchant_name ?> List of Published Products</p>
                        ...
                        <div class="panel-body profile">
                            ...
                            <div class="profile-data">
                                ...
                                <div class="profile-data-title" style="color: pink">
                                    <del style="color: red">
                                    &8358;<?php echo number_format($listProduct['product_price']) ?> 
                                    </del><?php
                                    $bonus = (15/100)*$listProduct['product_price']; ?>
                                    <strong>&8358;<?php echo number_format($bonus+$listProduct['product_price']) ?></strong> 
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-12"><?php 
                    if($totalItems > 1){
                        if($page != $totalPages){ ?>
                            <div align="left">
                                <a href="my-published-products.php?page=<?php echo $page + 1;?>" class="btn btn-primary">NEXT PAGE
                                </a>
                            </div><?php
                        } 
                        if($page != 1){ ?>
                            <div align="right" style="margin-top: -30px">
                                <a href="my-published-products.php?page=<?php echo $page - 1;?>" class="btn btn-success">PREVIOUS PAGE
