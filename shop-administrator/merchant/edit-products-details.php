...
<ul class="breadcrumb">
    ...
    <li><a href="my-products-list.php"><i class="fa fa-list"></i> View All Product</p></a></li>  
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="panel panel-default">
                <div class="panel-body profile" style="background: url('<?php echo "../../assets/images/products-images/large-image/".$ragzProduct['product_image'] ?>') center center no-repeat;">
			                    ...
			                    <div class="form-group col-md-12">
					                ...
					                <div class="panel-body form-group-separated">    
					                    ...
					                    <div class="col-md-10 col-xs-12">
					                    	<div class="input-group">
					                            <span class="input-group-addon"><span class="fa fa-sitemap"></span></span>
					                            <input type="text" class="form-control text" name="product_size" placeholder="Enter The Product Size" value="<?php echo $ragzProductDetails['product_size'] ?>" required />
					                        </div>                                            
					                        <span class="help-block" style="color: red;">This is field is Required.</span>
					                    </div>
					                </div>
